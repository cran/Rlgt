...
#include "stanExports_noglobalSGT.h"

RCPP_MODULE(stan_fit4noglobalSGT_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_noglobalSGT")

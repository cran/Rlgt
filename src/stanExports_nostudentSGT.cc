...
#include "stanExports_nostudentSGT.h"

RCPP_MODULE(stan_fit4nostudentSGT_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_nostudentSGT")

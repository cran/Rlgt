...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_nostudent");
    reader.add_event(97, 95, "end", "model_nostudent");
    return reader;
}

class model_nostudent
  : public stan::model::model_base_crtp<model_nostudent> {
private:
        double CAUCHY_SD;
        ...
        double reg0CauchySd;
public:
    model_nostudent(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_nostudent_namespace::model_nostudent";
        ...
        try {
            ...
            for (int t = 2; t <= N; ++t) {
                ...
                if (as_bool(logical_eq(USE_SMOOTHED_ERROR, 0))) {
                    ...
                    lp_accum__.add(normal_log<propto__>(get_base1(y, t, "y", 1), get_base1(expVal, t, "expVal", 1), ((sigma * pow(get_base1(expVal, t, "expVal", 1), powx)) + offsetSigma)));
                } else {
                    current_statement_begin__ = 93;
                    lp_accum__.add(normal_log<propto__>(get_base1(y, t, "y", 1), get_base1(expVal, t, "expVal", 1), ((sigma * get_base1(smoothedInnovSize, (t - 1), "smoothedInnovSize", 1)) + offsetSigma)));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_nostudent_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_nostudent_namespace::model_nostudent stan_model;

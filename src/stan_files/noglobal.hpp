...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_noglobal");
    reader.add_event(97, 95, "end", "model_noglobal");
    return reader;
}

class model_noglobal
  : public stan::model::model_base_crtp<model_noglobal> {
private:
        double CAUCHY_SD;
...
typedef model_noglobal_namespace::model_noglobal stan_model;

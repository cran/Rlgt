...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_nohet");
    reader.add_event(97, 95, "end", "model_nohet");
    return reader;
}

class model_nohet
  : public stan::model::model_base_crtp<model_nohet> {
private:
        double CAUCHY_SD;
        ...
        try {
            ...
            for (int t = 2; t <= N; ++t) {
                ...
                if (as_bool(logical_eq(USE_SMOOTHED_ERROR, 0))) {
                    ...
                    lp_accum__.add(student_t_log<propto__>(get_base1(y, t, "y", 1), nu, get_base1(expVal, t, "expVal", 1), offsetSigma));
                } else {
...
typedef model_nohet_namespace::model_nohet stan_model;

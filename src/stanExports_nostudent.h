...
public:
  ...
  inline std::string model_name() const final { return "model_nostudent"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_nostudent_namespace::log_prob";
(void) function__;  // suppress unused var warning
                               ...
                               smoothedInnovSize[(sym1__ - 1)], 0);}
      {
        ...
        for (int t = 2; t <= N; ++t) {
          ...
          if (logical_eq(USE_SMOOTHED_ERROR, 0)) {
            ...
            lp_accum__.add(
              normal_lpdf<propto__>(y[(t - 1)], expVal[(t - 1)],
